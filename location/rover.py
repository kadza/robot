                ...
                if error_indicator == 0:
                    ...
                    while data:
                        try:
                            ...
                            if bytes("GNGGA", "ascii") in raw_data:
                                print(raw_data)
                                location = self.parse_gngga_sentence(
                                ...
                                if location:
                                    ...
                                    print(
                                        f"Parsed Location: Latitude={lat}, Longitude={lon}, Fix Status={fix_status}"
                                    )
                                if self.gps_file:
...
if __name__ == "__main__":
    ...
    if options.org:
        if len(args) != 1:
            print(
                "Incorrect number of arguments for IBSS. You do not need to provide the server and port\n"
            )
            parser.print_help()
            sys.exit(1)
